      ...
      bottomNavigationBar: Padding(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(onPressed: (){
            Navigator.pushNamed(context, "/RequestRentPageTwo");
          },
              style: ButtonStyle(
                  backgroundColor: WidgetStateProperty.all(MyColor.buttonColor),
                  shape: WidgetStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)))
              ),
              child: Text("Confirm Booking",style: regularTextStyleHintText16.copyWith(color: MyColor.whiteColor),)),
        ),
      ),
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            TextFieldWidget(title: "Date"),
            const SizedBox(height: 16,),
            TextFieldWidget(title: "Time"),
            const SizedBox(height: 30,),
